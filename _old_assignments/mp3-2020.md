...
a. Use [this site]()
b. Use [this site](http://pano.sentiovr.com/)
c. Do it yourself using code...check out [this stackoverflow post](https://stackoverflow.com/questions/29678510/convert-21-equirectangular-panorama-to-cube-map). The python code is older but probably still usable...also the seocnd answer point to OpenCV which should be able to do this. If you are really interested in computational photography you can try this option.
