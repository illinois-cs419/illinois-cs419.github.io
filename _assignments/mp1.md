...
**1. Ray-object intersection support for:**<br/>
    &ndsp;&ndsp;&ndsp;**Planes** <br/> Reference: [Basic Ray Tracing Jan 28.](https://illinois-cs419.github.io/schedule)<br/>
    &ndsp;&ndsp;&ndsp;**Spheres** <br/> Reference: [Ray-Sphere Intesection Feb.2](https://illinois-cs419.github.io/schedule) <br/>  Reference: [RTiOW Section 5](https://raytracing.github.io/books/RayTracingInOneWeekend.html#addingasphere)<br/>
    &ndsp;&ndsp;&ndsp;**Triangles** <br/> Reference: [Ray-Triangle Intersection Feb. 9](https://illinois-cs419.github.io/schedule)
