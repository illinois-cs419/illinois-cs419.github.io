...
3. If there was a collison, calculate a reflection vector. The incident vector is can be calculated as $$R_i = c_1 - c_0$$ and the normal is $$N=(-1,0,0)$$ in this case. The reflection vector is then $$R_i-2N(R_i \cdot N)$$. This becomes the new direction for the sphere and the speed of the sphere can be $$cs_0$$ where $$s_0$$ is the original speed of the sphere and $$c \in [0,1]$$ is the coefficient of restitution. Again, all of this is for the special case of hitting a non-moving wall. 
